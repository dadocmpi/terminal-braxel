        ...
        <div className="hidden md:flex items-center gap-6">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              <div className={`w-1.5 h-1.5 ${isWeekend ? 'bg-muted-foreground' : isMarketOpen ? 'bg-bull shadow-[0_0_8px_#22c55e]' : 'bg-bear'}`} />
              <span className="text-[10px] font-bold text-white uppercase">
                {isWeekend ? 'RESTING' : isMarketOpen ? 'OPERATIONAL' : 'STANDBY'}
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-primary uppercase">
                {isWeekend ? 'MARKET_CLOSED' : currentSession}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center gap-4">
        <div className="hidden lg:flex items-center gap-4 mr-4 border-r border-white/10 pr-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-mono text-muted-foreground">CPU: 4%</span>
          </div>
          <div className="flex items-center gap-2">
